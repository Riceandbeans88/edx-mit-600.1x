...
Our goal is to keep the code modular -
if you want to try playing your word game with n=10 or n=4,
...
before running test_ps4a.py.
You have to do this every time you modify the file ps4a.py
and want to run the file test_ps4a.py, otherwise changes to the former will not be incorporated in the latter.
'''
